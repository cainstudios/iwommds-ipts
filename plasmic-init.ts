...
import { DataTable, RestQuery, TableColumn, TableValue } from "./components/app-builder";

export const PLASMIC = initPlasmicLoader({
  projects: [
    {
      id: "dwCuEjGoWEhYoFqzPWBNDu",
      token: "IRYOSnJBwCGt5pAHouxJW1oiM20aedSKNlmJzl4FAXcsO7k4aw4NUEP0ShQt7ZRHgILA2tIPLUSOu3qfKTw",
    },
  ],
